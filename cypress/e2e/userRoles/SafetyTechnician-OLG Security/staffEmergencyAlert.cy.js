...
describe('Triggering Staff emergency alert and performing functionality on the triggered alert', () => {
  ...
  it('Trigger staff Emergency alert and perform acknowledge and unacknowledged functionality from the side panel', () => {
    HelperFunction.globalIntercept()
    //Login to Leverage architect  and trigger the alert
    Safety.triggerStaffAlerts(staffName, staffEmergency)

    // Applying alert Filter
    Safety.selectAlertTypeFromFilter(staffEmergency)

    //Acknowledging alert from side panel
    Safety.acknowledgeAlert(staffDetails, sidePanel, staffEmergency, deviceId)
    ...
    // //unacknowledging alert from side panel
    // Safety.unAcknowledgedAlert(staffDetails, staffEmergency, sidePanel)
    // Verify.theToast.showsToastMessage(messageAfterEventUnacknowledge)
  })

  it('Trigger staff Emergency alert and perform acknowledge and unacknowledged functionality from the table view', () => {
    HelperFunction.globalIntercept()
    //Login to Leverage architect  and trigger the alert
    Safety.triggerStaffAlerts(staffName, staffEmergency)
    ...
    //Acknowledging alert from table view
    Safety.acknowledgeAlert(staffDetails, tableView, staffEmergency, deviceId)
    Verify.theToast.showsToastMessage(messageAfterAlertAcknowledge)
    ...
    // //unacknowledging alert from table view
    // Safety.unAcknowledgedAlert(staffDetails, staffEmergency, tableView)
    // Verify.theToast.showsToastMessage(messageAfterEventUnacknowledge)
  })

  it('Trigger staff Emergency alert and perform acknowledge and unacknowledged functionality from the carousel', () => {
    HelperFunction.globalIntercept()
    //Login to Leverage architect  and trigger the alert
    Safety.triggerStaffAlerts(staffName, staffEmergency)
    //Applying alert Filter
    ...
    //Acknowledging alert from carousel
    SmartLocation.acknowledgeEmergencyAlert(commentForAcknowledge, staffName, staffId)
    Verify.theToast.showsToastMessage(messageAfterAlertAcknowledge)
  ...
  it('Trigger staff Emergency alert and perform Escalate functionality from the carousel', () => {
    ...
    SmartLocation.escalateAlert(option1, staffDetails, carousel, staffEmergency)
  ...
  it('Trigger staff Emergency alert and perform Escalate functionality from the side panel', () => {
    ...
    SmartLocation.escalateAlert(option1, staffDetails, sidePanel, staffEmergency)
    Verify.theToast.showsToastMessage(escalateAlert)
  })
